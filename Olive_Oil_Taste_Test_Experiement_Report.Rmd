...
Y= B0+B1M								                    	        (5)
Y=  B0+B1M+ B2C+B3T 						                                   (6)
Y=  B0+B1M+B2C+B3T + B4M*C+ B5M*T 					        (7)
...
S=  B0+B1M+B2O+B3C + B4T 					       		        (8)
B=  B0+B1M+B2O+B3XC+ B4T+ e 					       		        (9)
...
model_list=list(model1, model2, model3, model4)
 ...
 stargazer(
  ...
  notes.align="l",
  omit.stat="f",
  se=lapply(model_list, function(x)sqrt(diag(vcovHC(x, type = "HC1")))))
```
...
model_lista=list(model1a, model2a, model3a)
 ...
 stargazer(
  ...
  omit.stat="f",
  se=lapply(model_lista, function(x)sqrt(diag(vcovHC(x, type = "HC1"))))
 )
```
