...
model_listb=list(model1b, model2b, model3b)
 stargazer(
  ...
  column.sep.width = "1pt",
  omit.stat="f",
  se=lapply(model_listb, function(x)sqrt(diag(vcovHC(x, type = "HC1"))))
 )
```
...
model_list2=list(model3, model4)
 stargazer(
  ...
  type = 'text',
  column.labels=c("Preferred Smell Model",  "Bitter Model"),
  covariate.labels=c('Received positive messaging on olive oil 2', 'Had covid', 'Has olive oil tasting experience'),
  model.numbers =FALSE,
  dep.var.labels.include = FALSE,
  omit.stat=c("f"),
  se=lapply(model_list2, function(x)sqrt(diag(vcovHC(x, type = "HC1"))))
 )
```
